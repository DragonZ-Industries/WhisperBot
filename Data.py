...
By @DragonZBots
    ...
    buttons = [
        ...
        [InlineKeyboardButton("♥ More Amazing bots ♥", url="https://t.me/DragonZBots")],
        [InlineKeyboardButton("🎨 Support Group 🎨", url="https://t.me/DragonZBots")],
    ]
...
`@WhisperDragonBot your_message friend_username/id`
    """
...
Bot created by @DragonZBots

Source Code : [Click Here](https://github.com/DragonZ-Industries/WhisperBot)
