...
main = [
    InlineQueryResultArticle(
        ...
        url="https://t.me/DragonZBots",
        description="Write Target User's @username or id at the end of your message.",
        thumb_url="https://te.legra.ph/file/33af12f457b16532e1383.jpg",
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Learn More", url="https://t.me/WhisperDragonBot?start=start")],
